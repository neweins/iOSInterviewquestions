...
## iOS
- Bounds 와 Frame 의 차이점을 설명하시오. -> [참고자료](https://hyun083.tistory.com/67)
- 실제 디바이스가 없을 경우 개발 환경에서 할 수 있는 것과 없는 것을 설명하시오. -> [참고자료](https://meenu.tistory.com/20)
- 앱의 콘텐츠나 데이터 자체를 저장/보관하는 특별한 객체를 무엇이라고 하는가? ->[참고자료](https://hilily.tistory.com/43)
